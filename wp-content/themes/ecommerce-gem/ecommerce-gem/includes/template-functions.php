...
function ecommerce_gem_body_classes( $classes ) {
	...
	if ( in_array( 'woocommerce/woocommerce.php', apply_filters( 'active_plugins', get_option( 'active_plugins' ) ) ) && is_page_template( 'templates/home.php' ) ) {
		$classes[] = 'woocommerce';
	}

	//Add column-3 in body for woocommerce
	$classes[] = 'columns-3';
