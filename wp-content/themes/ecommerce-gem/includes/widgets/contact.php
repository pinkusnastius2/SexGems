							...
							<div class="contact-inner">
								...
								if( !empty( $text_one ) ){ ?>
									<div class="contact-text-wrap">
									   <p><a href="mailto:sales@sexgems.co.uk">Email Sales</a></p>
					...
					<?php if( !empty( $icon_two ) || !empty( $text_two ) ){ ?>
						<div class="contact-item">
							<div class="contact-inner">
								...
								if( !empty( $text_two ) ){ ?>
									<div class="contact-text-wrap">
									   <p><a href="mailto:support@sexgems.co.uk">Email Support</a></p>
									</div> <!-- .contact-text-wrap -->
									<?php 
								} ?>
							</div>
					...
					<?php if( !empty( $icon_three ) || !empty( $text_three ) ){ ?>
						<div class="contact-item">
							<div class="contact-inner">
								...
								if( !empty( $text_three ) ){ ?>
									<div class="contact-text-wrap">
									   <p><a href="https://www.sexgems.co.uk/?page_id=4300">Contact Us</a></p>
									</div> <!-- .contact-text-wrap -->
									<?php 
								} ?>
							</div>
					...
					<?php if( !empty( $icon_four ) || !empty( $text_four ) ){ ?>
						<div class="contact-item">
							<div class="contact-inner">
								...
								if( !empty( $text_four ) ){ ?>
									<div class="contact-text-wrap">
									   <p><a href="https://www.facebook.com/SexGems-399222717211986/">Facebook Page</a></p>
									</div> <!-- .contact-text-wrap -->
									<?php 
								} ?>
							</div>
