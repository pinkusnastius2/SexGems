						...
						<?php if ( ! empty( $title ) || ! empty( $sub_title ) ){ ?>
							...
							<div class="newsletter-text">
								...
								<span class="newsletter-icon">
									<?php /*<img src="<?php echo get_template_directory_uri(); ?>/assets/images/envelope.png" alt="<?php esc_attr_e( 'newsletter', 'ecommerce-gem' ); ?>"> */ ?>
								...
								if ( $title ) {
									echo '<h2><a href="https://mailchi.mp/a11cbd34a1cc/sexgems" target="_blank">' . esc_html( $title ) . '</a></h2>';
								}

								if ( $sub_title ) { ?>

									<p><a href="https://mailchi.mp/a11cbd34a1cc/sexgems" target="_blank"><?php echo esc_html( $sub_title ); ?></a></p>
